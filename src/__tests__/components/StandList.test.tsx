...
function seedStore() {
  ...
  useForestStore.getState().setCompartmentSpecies([
    { id: "s1", forest_id: "f1", compartment_id: "c1", stand_id: "1", species: "pine", volume_m3: 200, log_pct: 60, area_ha: 2.0, stem_count: null, mean_height: null, mean_diameter: null, age: null, basal_area: null, created_at: "" },
    { id: "s2", forest_id: "f1", compartment_id: "c1", stand_id: "1", species: "spruce", volume_m3: 100, log_pct: 40, area_ha: 0.5, stem_count: null, mean_height: null, mean_diameter: null, age: null, basal_area: null, created_at: "" },
  ]);
