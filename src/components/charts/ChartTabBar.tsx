      ...
      <div className="flex-1 flex overflow-x-auto scrollbar-hide">
        {tabs.map((tab) => (
          <button
            ...
            className={`flex items-center gap-1 px-3 py-2 text-xs rounded-t-lg whitespace-nowrap shrink-0 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-300 ${
              activeId === tab.id
