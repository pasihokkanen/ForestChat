...
export default function ChartTabBar({
  ...
  return (
    <div className="flex items-center h-11 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-b from-gray-200 to-gray-100 dark:from-gray-700 dark:to-gray-800 shrink-0">
      <div className="flex-1 flex overflow-x-auto scrollbar-hide">
        {tabs.map((tab) => (
          <button
            ...
            className={`flex items-center gap-1 px-3 py-2 text-xs rounded-t-lg whitespace-nowrap shrink-0 hover:bg-gray-100 dark:hover:bg-gray-700 transition-[background-color,color,box-shadow] duration-200 ${
              activeId === tab.id
