    ...
    <div className="flex items-center h-11 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 shrink-0">
      {TAB_DEFS.map((tab) => (
        <button
          ...
          className={`flex items-center gap-1.5 px-4 py-2 text-sm rounded-t-lg border-r border-gray-200 dark:border-gray-700 transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 ${
