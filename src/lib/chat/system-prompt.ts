...
export function buildSystemPrompt(
  ...
  return [
    ...
    ``,
    `  Filters: development_class, site_type, species etc. work on compartments source`,
    `    only. compartment_species has NO development_class — switch to compartments`,
    `    source when filtering by stand attributes.`,
    ``,
