...
export function buildSystemPrompt(
  ...
  return [
    ...
    `- Database column names are SINGULAR: development_class (NOT development_classes),`,
    `  site_type (NOT site_types), stand_id (NOT stand_ids).`,
    ...
    `  * Species distribution FILTERED by development class (e.g. "regeneration-ready stands"):`,
    `    Use compartments source with a development_class filter. Groups by main_species:`,
    `    { source: "compartments", aggregate: [{ group_by: "main_species" }],`,
    `      values: [{ field: "area_ha", as: "total_ha", fn: "sum" }],`,
    `      filters: { development_class: "Uudistuskypsä metsikkö" } }`,
    `    Valid development_class values: "Uudistuskypsä metsikkö" (regeneration-ready),`,
    `    "Varttunut kasvatusmetsikkö" (mature thinning), "Nuori kasvatusmetsikkö" (young`,
    `    thinning), "Taimikko yli 1.3 m", "Taimikko alle 1.3 m".`,
    `    NOTE: column name is development_class (SINGULAR), never development_classes!`,
