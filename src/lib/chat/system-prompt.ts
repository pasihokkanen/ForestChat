...
export function buildSystemPrompt(
  ...
  return [
    ...
    `- "Harvests" (income, positive €) = Päätehakkuu, Harvennus, Ensiharvennus, Poimintahakkuu`,
    `  These have income_eur > 0 and cost_eur = 0.`,
    `- "Silvicultural work" / "maintenance" / "regeneration" (costs, negative €) = Laikkumätästys, Ojitusmätästys, Laikutus, Istutus, Kuusen istutus, Männyn istutus, Taimikonhoito, Taimikon varhaishoito, Ennakkoraivaus`,
    ...
    `  * Multi-species area/volume (uses full species breakdown, not just main):`,
