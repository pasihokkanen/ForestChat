...
const mockCompartments: Compartment[] = [
  {
    ...
    avg_diameter: 22.0, avg_height: 16.5, stem_count_per_ha: null,
      growth_m3_per_ha: 4.2,
  ...
  },
  {
    ...
    avg_diameter: 30.0, avg_height: 22.0, stem_count_per_ha: null,
      growth_m3_per_ha: 5.8,
    geometry: null, attributes: null,
    created_at: "2025-01-01", updated_at: "2025-01-01",
  },
  {
    ...
    avg_diameter: 15.0, avg_height: 12.0, stem_count_per_ha: null,
      growth_m3_per_ha: 6.1,
    geometry: null, attributes: null,
    created_at: "2025-01-01", updated_at: "2025-01-01",
  },
];
